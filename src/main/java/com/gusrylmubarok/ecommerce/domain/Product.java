package com.gusrylmubarok.ecommerce.domain;
...
/**
 * Product sold by the Ecommerce
 */
@Schema(description = "Product sold by the Ecommerce")
@Entity
@Table(name = "product")
...
public class Product implements Serializable {
    ...
    public Product sizeProduct(SizeProduct sizeProduct) {
